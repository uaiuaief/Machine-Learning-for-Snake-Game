...
class Population:
    ...
    def save_genetic_data(self):
        ...
        if genetic_data != [[]] and genetic_data != []:
            try:
                with open(os.path.join(os.getcwd(), "genetic_data"), 'w') as file:
        ...
        if self.generation != '':
            try:
                with open(os.path.join(os.getcwd(), "generation"), 'w') as file:
        ...
        if fittest.food_position != '':
            try:
                with open(os.path.join(os.getcwd(), 'food_coord'), 'w') as file:
        ...
        if Population.plot_data != '':
            try:
                with open(os.path.join(os.getcwd(), 'plot_graph'), 'a') as file:
